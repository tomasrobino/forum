...
export default function ForumItem(props: {isCategory?: boolean, lastPost: string, timestamp: string, user: string, topics?: number, views?: number, posts: number, title: string, description: string}) {
  return(
